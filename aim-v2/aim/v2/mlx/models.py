...
from aim.v2.mlx import layers

import mlx.core as mx
from mlx import nn

from aim.v1.mlx import models
...
class AIMv2LiT(nn.Module):
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.log_logit_scale = mx.full([], vals=math.log(1.0 / init_temperature))
    ...
    def __call__(
        ...
        img_embeds = img_embeds / mx.linalg.norm(
        ...
        logit_scale = mx.clip(self.log_logit_scale, 0.0, self.max_log_logit_scale)
        logit_scale = mx.exp(logit_scale)
